...
- **Kanban** — [docs/kanban/unplanned/](kanban/unplanned/) lists the prioritized roadmap (global sequence **50–67**, lower = higher priority); completed stories live under [docs/kanban/done/](kanban/done/) (**01–49**). Stories progress through **planned**, **doing**, and **done** as described in [docs/kanban/README.md](kanban/README.md).
