...
- Sequence **62** (VM test fixtures) is a smaller, fixture-focused slice; prefer folding fixture work into this story unless splitting helps incremental delivery.
