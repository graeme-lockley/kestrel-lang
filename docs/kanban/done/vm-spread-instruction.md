...
- Unplanned story `docs/kanban/unplanned/vm-spread-instruction.md` covers the same VM work; this backlog story aligns with the language-spec review. Compiler record spread codegen is a separate story.
