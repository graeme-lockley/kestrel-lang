...
- `stdlib/kestrel/stack.ks`: `format` and `print` exported (`trace` is deferred to sequence **50** — `docs/kanban/unplanned/50-stdlib-stack-trace-implementation.md`); no `stack.test.ks`.
