...
- Unplanned story `docs/kanban/unplanned/S06-01-vm-spread-instruction.md` covers follow-up verification; this done entry records the VM work. Compiler record spread codegen is a separate story (`38-compiler-record-spread-codegen.md`).
