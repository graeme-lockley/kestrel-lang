...
3. [S15-03-compiler-mode-and-provenance-state.md](../../planned/S15-03-compiler-mode-and-provenance-state.md) — Add explicit compiler mode/provenance state and visible status reporting.
