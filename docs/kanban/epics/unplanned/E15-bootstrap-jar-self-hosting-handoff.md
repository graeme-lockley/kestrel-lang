...
2. [S15-02-kestrel-bootstrap-command.md](../../planned/S15-02-kestrel-bootstrap-command.md) — Add `./kestrel bootstrap` to seed self-hosted compiler classes from the bootstrap JAR.
