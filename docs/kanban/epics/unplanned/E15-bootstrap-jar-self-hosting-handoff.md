...
4. [S15-04-default-cli-self-hosted-compiler-path.md](../../planned/S15-04-default-cli-self-hosted-compiler-path.md) — Switch default `build`/`run`/`test` compile paths to self-hosted classes and prevent bootstrap-JAR use in normal flow.
