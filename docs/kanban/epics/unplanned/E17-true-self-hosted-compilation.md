...
S17-43 (codegenMeta) is a prerequisite for S17-22 (cross-module ADT environment) and S17-38
(JvmCodegenOptions), and S17-40 (serializeType) is a prerequisite for S17-43.

16. [S17-40 — Fix KTI `serializeType` to write JSON object format](../../unplanned/S17-40-kti-serialize-type-json-format.md)
...
17. [S17-41 — Add `freshenImportedTypeVars` to KTI `loadDepBindings`](../../unplanned/S17-41-kti-freshen-imported-type-vars.md)
...
18. [S17-43 — Fix KTI `codegenMeta` extraction and serialisation](../../unplanned/S17-43-kti-codegenmeta-correctness.md)
    ...
    to match the TS reference (`compiler/src/kti.ts` lines 202–445). Depends on S17-40.
...
- S17-40, S17-41, S17-43 fix KTI correctness gaps (type serialisation format, imported type var
  freshening, codegenMeta extraction/serialisation). Scheduled before the typechecker and
  codegen gap closures because S17-43 is a prerequisite for S17-22 and S17-38, and S17-40 is
