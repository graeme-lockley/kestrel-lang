...
- [ ] Create `stdlib/kestrel/data/`, `stdlib/kestrel/io/`, `stdlib/kestrel/sys/`, `stdlib/kestrel/dev/` directories (`.gitkeep` if needed)
- [ ] Move and update `stdlib/kestrel/basics.ks` → `stdlib/kestrel/data/basics.ks` (no internal kestrel: imports to update)
- [ ] Move and update `stdlib/kestrel/basics.test.ks` → `stdlib/kestrel/data/basics.test.ks` (update `kestrel:basics` → `kestrel:data/basics`, `kestrel:test` stays)
- [ ] Move and update `stdlib/kestrel/char.ks` → `stdlib/kestrel/data/char.ks` (update `kestrel:basics` → `kestrel:data/basics`)
- [ ] Move and update `stdlib/kestrel/char.test.ks` → `stdlib/kestrel/data/char.test.ks`
- [ ] Move and update `stdlib/kestrel/string.ks` → `stdlib/kestrel/data/string.ks` (update internal imports)
- [ ] Move and update `stdlib/kestrel/string.test.ks` → `stdlib/kestrel/data/string.test.ks`
- [ ] Move and update `stdlib/kestrel/list.ks` → `stdlib/kestrel/data/list.ks` (update internal imports)
- [ ] Move and update `stdlib/kestrel/list.test.ks` → `stdlib/kestrel/data/list.test.ks`
- [ ] Move and update `stdlib/kestrel/dict.ks` → `stdlib/kestrel/data/dict.ks` (update internal imports)
- [ ] Move and update `stdlib/kestrel/dict.test.ks` → `stdlib/kestrel/data/dict.test.ks`
- [ ] Move and update `stdlib/kestrel/set.ks` → `stdlib/kestrel/data/set.ks` (update internal imports)
- [ ] Move and update `stdlib/kestrel/set.test.ks` → `stdlib/kestrel/data/set.test.ks`
- [ ] Move and update `stdlib/kestrel/tuple.ks` → `stdlib/kestrel/data/tuple.ks` (update internal imports)
- [ ] Move and update `stdlib/kestrel/tuple.test.ks` → `stdlib/kestrel/data/tuple.test.ks`
- [ ] Move and update `stdlib/kestrel/option.ks` → `stdlib/kestrel/data/option.ks` (update internal imports)
- [ ] Move and update `stdlib/kestrel/option.test.ks` → `stdlib/kestrel/data/option.test.ks`
- [ ] Move and update `stdlib/kestrel/result.ks` → `stdlib/kestrel/data/result.ks` (update internal imports)
- [ ] Move and update `stdlib/kestrel/result.test.ks` → `stdlib/kestrel/data/result.test.ks`
- [ ] Move and update `stdlib/kestrel/json.ks` → `stdlib/kestrel/data/json.ks` (update internal imports)
- [ ] Move and update `stdlib/kestrel/json.test.ks` → `stdlib/kestrel/data/json.test.ks`
- [ ] Move and update `stdlib/kestrel/console.ks` → `stdlib/kestrel/io/console.ks` (update internal imports)
- [ ] Move and update `stdlib/kestrel/fs.ks` → `stdlib/kestrel/io/fs.ks` (update internal imports)
- [ ] Move and update `stdlib/kestrel/fs.test.ks` → `stdlib/kestrel/io/fs.test.ks`
- [ ] Move and update `stdlib/kestrel/http.ks` → `stdlib/kestrel/io/http.ks` (update internal imports)
- [ ] Move and update `stdlib/kestrel/http.test.ks` → `stdlib/kestrel/io/http.test.ks`
- [ ] Move and update `stdlib/kestrel/process.ks` → `stdlib/kestrel/sys/process.ks` (update internal imports)
- [ ] Move and update `stdlib/kestrel/process.test.ks` → `stdlib/kestrel/sys/process.test.ks`
- [ ] Move and update `stdlib/kestrel/task.ks` → `stdlib/kestrel/sys/task.ks` (update internal imports)
- [ ] Move and update `stdlib/kestrel/task.test.ks` → `stdlib/kestrel/sys/task.test.ks`
- [ ] Move and update `stdlib/kestrel/runtime.ks` → `stdlib/kestrel/sys/runtime.ks` (no internal imports usually)
- [ ] Move and update `stdlib/kestrel/stack.ks` → `stdlib/kestrel/dev/stack.ks` (update `kestrel:list` → `kestrel:data/list`)
- [ ] Move and update `stdlib/kestrel/stack.test.ks` → `stdlib/kestrel/dev/stack.test.ks`
- [ ] Update all non-stdlib `.ks` files that import the 17 moved modules (bulk sed: replace `"kestrel:X"` → `"kestrel:data/X"` etc. for each mapping)
- [ ] Update `stdlib/kestrel/array.ks` internal imports (references `kestrel:list`, `kestrel:option`, etc.)
- [ ] Update `stdlib/kestrel/array.test.ks` internal imports
- [ ] Update `stdlib/kestrel/test.ks` internal imports (references `kestrel:basics`, `kestrel:console`, `kestrel:list`, `kestrel:stack`, `kestrel:string`, `kestrel:task`)
- [ ] Update `stdlib/kestrel/socket.ks` internal imports (if it references moved modules)
- [ ] Update `stdlib/kestrel/socket.test.ks` internal imports
- [ ] Update `stdlib/kestrel/web.ks` internal imports
- [ ] Update `stdlib/kestrel/web.test.ks` internal imports
- [ ] Update `scripts/run_tests.ks` imports
- [ ] Update `scripts/run-e2e.sh` (one import inside an inline heredoc; replace `kestrel:process` → `kestrel:sys/process`)
- [ ] Update root example files: `hello.ks`, `mandelbrot.ks`
...
- [ ] `docs/specs/02-stdlib.md` — rename all `## kestrel:X` section headings to `## kestrel:data/X`, `## kestrel:io/X`, `## kestrel:sys/X`, `## kestrel:dev/X` per the E08 namespace table
- [ ] `docs/specs/07-modules.md` — add namespace map table showing the restructure; update any examples that use old flat paths
