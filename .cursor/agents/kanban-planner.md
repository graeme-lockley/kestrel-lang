...
2. Add or complete: **Impact analysis**, **Tasks** (checkboxes), **Tests to add**, **Documentation and specs to update**, and optional **Notes**. **Impact analysis** must reflect unplanned **Goals** and **Risks / notes** (expand into concrete files, mitigations, and ordering).
3. Align tasks with **Goals**, acceptance criteria, and spec references; ensure test and doc lists are **actionable** (paths or concrete file patterns).
