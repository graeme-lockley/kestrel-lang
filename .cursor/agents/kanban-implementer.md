...
2. Follow **kestrel-feature-delivery** and **AGENTS.md**: parser/typecheck/codegen/JVM/VM as needed; mandatory tests; spec updates. Re-read **Goals**, **Risks / notes**, and **Impact analysis** when trade-offs appear so mitigations stay explicit in **Build notes**.
