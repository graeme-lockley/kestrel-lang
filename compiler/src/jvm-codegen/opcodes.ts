/**
 * JVM bytecode opcodes (subset needed for Kestrel codegen).
 * Class file version 50 (Java 6) — no StackMapTable.
 */
export const enum JvmOp {
  NOP = 0x00,
  ACONST_NULL = 0x01,
  ICONST_M1 = 0x02,
  ICONST_0 = 0x03,
...
export const ACC_SYNCHRONIZED = 0x0020; // method
export const ACC_VOLATILE = 0x0040;
export const ACC_BRIDGE = 0x0040; // method
export const ACC_TRANSIENT = 0x0080;
export const ACC_VARARGS = 0x0080; // method
